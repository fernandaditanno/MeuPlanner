    ...
    public partial class Inicial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Contato", t => t.ContatoClienteId)
                .ForeignKey("dbo.Contato", t => t.ContatoColaboradorId)
                ...
                c => new
                    {
                        ...
                        Horario = c.String(maxLength: 100),
                        ContatoClienteId = c.Int(nullable: false),
                        DescricaoEvento = c.String(nullable: false, maxLength: 1000),
                        PermissaoVisualizacaoId = c.Int(nullable: false),
                        UsuarioCadastro = c.String(maxLength: 100),
                        DataCadastro = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Contato", t => t.ContatoClienteId)
                .ForeignKey("dbo.Permissao", t => t.PermissaoVisualizacaoId)
                .Index(t => t.ContatoClienteId)
                .Index(t => t.PermissaoVisualizacaoId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        NomeDaTela = c.String(nullable: false, maxLength: 100),
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ContatoClienteId = c.Int(nullable: false),
                        NumeroProcesso = c.String(nullable: false, maxLength: 80),
                        Descricao = c.String(maxLength: 1000),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Evento", "PermissaoVisualizacaoId", "dbo.Permissao");
            ...
            DropIndex("dbo.Evento", new[] { "PermissaoVisualizacaoId" });
